...
- MCP server: `sdwan/sdwan_mcp/server.py`
- management API and SSE: `sdwan/management/app.py`
- Claude runner and stream normalization: `sdwan/management/agent.py`
- shared query service and route reporting: `sdwan/management/service.py`
- constrained runtime adapter: `sdwan/management/runtime.py`
- session, chat, and audit persistence: `sdwan/management/repository.py`
- authentication and RBAC: `sdwan/management/auth.py`
- configuration: `sdwan/management/config.py`

## Baseline commands and results

```bash
PYTHONPATH=$PWD /home/joubran/ryu-venv38/bin/python -m unittest discover -s sdwan/tests -v
```
