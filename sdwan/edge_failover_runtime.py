...
from sdwan.common.marks import EgressMode
from sdwan.common.model import TopologyConfig, load_config
from sdwan.dynamic_profile import overlay_site_profile
from sdwan.common.path_selection import ApplicationClass, MetricWindow, NoEligibleAction, PathSelector
from sdwan.edge_agent_v5 import ClassMarkRule, CommandError, EdgeAgent, SystemRunner
from sdwan.hub_health import aggregate_hub
from sdwan.local_failover import LocalFailoverManager, SlotTarget
from sdwan.route_resolver import RouteResolver, Target
from sdwan.tunnel_health import StaleMeasurement, TunnelHealth, TunnelHealthMachine, TunnelSample, TunnelState
...
def main() -> int:
    ...
    parser.add_argument("--config", type=Path, default=Path("/opt/sdwan/config/topology.core.yaml"))
