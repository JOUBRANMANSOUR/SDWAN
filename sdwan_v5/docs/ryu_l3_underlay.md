...
SDWAN_TOPOLOGY_CONFIG=$PWD/sdwan_v5/config/topology.core.yaml   bash sdwan_v5/scripts/run_topology.sh
SDWAN_TOPOLOGY_CONFIG=$PWD/sdwan_v5/config/topology.core.yaml   SDWAN_UNDERLAY_MODE=ENFORCE   SDWAN_STATE_ROOT=/mnt/data/sdwan-state   bash sdwan_v5/scripts/run_controller.sh
```
